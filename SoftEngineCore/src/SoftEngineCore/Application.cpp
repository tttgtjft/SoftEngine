...
namespace SoftEngine {
	...
	int Application::start(unsigned int window_weight, unsigned int window_height, const char* title)
	{
        GLFWwindow* window;
        ...
        window = glfwCreateWindow(window_weight, window_height, title, NULL, NULL);
        if (!window)
        {
            glfwTerminate();
            return -1;
